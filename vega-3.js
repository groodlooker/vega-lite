...
looker.plugins.visualizations.add({
  create: function(element, config) {
    ...
    css.type = "text/css";
    css.innerHTML =
      "#vg-tooltip-element { font-family: Open Sans,Helvetica,Arial,sans-serif}";
  ...
  updateAsync: function(data, element, config, queryResponse, details, done) {
    ...
    if (Object.keys(config).length > 3) {
      ...
      for (var fieldChoice in config) {
        if (typeof config[fieldChoice] != "object") {
          if (fieldSettingArray.includes(fieldChoice)) {
            if (
              !allFields.includes(config[fieldChoice]) &&
              config[fieldChoice] != ""
            ) {
              var updateArray = [];
              var updateObj = {};
          ...
          if (typeof obj[key]["links"] != "undefined") {
            ...
            for (var l = 0; l < obj[key]["links"].length; l++) {
              ...
              currentLabel =
                currentLabel +
                " (" +
                key.substring(key.indexOf(".") + 1).replace(/_/g, " ") +
                ")";
      ...
      if (
        typeof config["row"] != "undefined" &&
        typeof config["row"] != "" &&
        config["fixed_height"] == null
      ) {
      ...
      if (
        typeof config["column"] != "undefined" &&
        config["column"] != "" &&
        config["fixed_width"] == null
      ) {
        for (var x = 0; x < myData.length; x++) {
      ...
      if (
        typeof config["fixed_height"] != "undefined" &&
        config["fixed_height"] != null
      ) {
      ...
      for (var datum in dataProperties) {
        ...
        if (config["includeInTip"] != "") {
          fieldsToExclude = config["includeInTip"]
            .split(",")
            .map(function(item) {
              return item.trim();
            });
      ...
      if (config["column"] != "" && typeof config["column"] != "undefined") {
        ...
        chart.facet.column = {
          field: config["column"],
          type: dataProperties[config["column"]]["dtype"],
          title: dataProperties[config["column"]]["title"]
        };
      ...
      if (config["row"] != "" && typeof config["row"] != "undefined") {
        ...
        chart.facet.row = {
          field: config["row"],
          type: dataProperties[config["row"]]["dtype"],
          title: dataProperties[config["row"]]["title"]
        };
        // check for independent axes
        if (config["resolve_y"] != "" && config["y"] != "") {
          chart.resolve = { scale: { y: "independent" } };
      ...
      if (
        config["highlight"] != "" &&
        typeof config["highlight"] != "undefined"
      ) {
      ...
      if (typeof secondLayer != "undefined" && secondLayer != "") {
        if (
          config["domain2"] != "" &&
          typeof config["domain2"] != "undefined"
        ) {
          var colorDomain2 = [];
          //parse the string input by user into array of integers
      ...
      if (
        ...
        chart.spec.layer[0].encoding.color = {
          condition: {
            ...
            field: config["highlight"],
            type: dataProperties[config["highlight"]]["dtype"],
            title: dataProperties[config["highlight"]]["title"]
          },
          //value if false
          value: "#B8B8B8"
        };
        ...
        chart.spec.layer[0].encoding.color = {
          field: config["color"],
          type: dataProperties[config["color"]]["dtype"],
      ...
      if (typeof secondLayer != "undefined" && secondLayer != "") {
        if (config["color2"] != "" && typeof config["color2"] != "undefined") {
          //if user has changed the field to color by
          //add color setting based on data type
          secondLayer.encoding.color = {
            field: config["color2"],
            type: dataProperties[config["color2"]]["dtype"],
            title: dataProperties[config["color2"]]["title"]
          };
          //check if quantitative or nominal
          if (dataProperties[config["color2"]]["dtype"] == "quantitative") {
            ...
            if (config["color_scheme2"] == "") {
              //if color scheme left on auto, assign the blues
              secondLayer.encoding.color.scale = {
                type: "sequential",
                scheme: "blues"
              };
            } else {
              ...
              secondLayer.encoding.color.scale = {
                type: "sequential",
                scheme: { name: config["color_scheme2"] },
                domain: colorDomain2
              };
            }
      ...
      if (config["shape"] != "" && typeof config["shape"] != "undefined") {
        chart.spec.layer[0].encoding.shape = {
          field: config["shape"],
          type: dataProperties[config["shape"]]["dtype"],
          title: dataProperties[config["shape"]]["title"]
        };
      }
      ...
      if (typeof secondLayer != "undefined" && secondLayer != "") {
        if (config["shape2"] != "" && typeof config["shape2"] != "undefined") {
          secondLayer.encoding.shape = {
            field: config["shape2"],
            type: dataProperties[config["shape2"]]["dtype"],
            title: dataProperties[config["shape2"]]["title"]
          };
        }
      }
      ...
      if (
        config["line_style"] != "" &&
        typeof config["line_style"] != "undefined" &&
        config["mark_type"] == "line"
      ) {
      ...
      if (typeof secondLayer != "undefined" && typeof secondLayer != "") {
        if (
          config["line_style2"] != "" &&
          typeof config["line_style2"] != "undefined" &&
          config["mark_type2"] == "line"
        ) {
      ...
      if (config["size"] != "" && typeof config["size"] != "undefined") {
        chart.spec.layer[0].encoding.size = {
          field: config["size"],
          type: dataProperties[config["size"]]["dtype"],
      ...
      if (typeof secondLayer != "undefined" && secondLayer != "") {
        if (config["size2"] != "" && typeof config["size2"] != "undefined") {
          secondLayer.encoding.size = {
            field: config["size2"],
            type: dataProperties[config["size2"]]["dtype"],
            title: dataProperties[config["size2"]]["title"]
          };
        } else {
      ...
      if (
        config["labelDefault"] != "" &&
        typeof config["labelDefault"] != "undefined"
      ) {
      ...
      if (
        config["labelField"] != "" &&
        typeof config["labelField"] != "undefined"
      ) {
        var labelPinY;
        var labelPinX;
        ...
        var labelLayer = {
          ...
          encoding: {
            text: {
              ...
              type: dataProperties[config["labelField"]]["dtype"],
              format: dataProperties[config["labelField"]]["valueFormat"]
            },
            y: {
              field: labelPinY,
              type: dataProperties[config["y"]]["dtype"],
        ...
        if (
          config["labelFilter"] != "" &&
          typeof config["labelFilter"] != "undefined"
        ) {
          var filterString;
          ...
          if (dataProperties[config["labelFilter"]]["dtype"] == "nominal") {
            filterString = {
              filter: {
                field: config["labelFilter"],
                oneOf: config["labelFilterValues"]
              }
            };
          } else if (
            dataProperties[config["labelFilter"]]["dtype"] == "quantitative"
          ) {
            filterString = {
              filter:
                "datum." +
        ...
        if (config["color"] != "" && typeof config["color"] != "undefined") {
          labelLayer.encoding.detail = [];
          labelLayer.encoding.detail.push({
            field: config["color"],
            type: dataProperties[config["color"]]["dtype"]
          });
        }
      ...
      if (config["order"] != "" && typeof config["order"] != "undefined") {
        chart.spec.layer[0].encoding.order = {
          field: config["order"],
          type: dataProperties[config["order"]]["dtype"],
          sort: config["order_type"]
        };
      }
      ...
      if (config["sort"] != "" && typeof config["sort"] != "undefined") {
        if (dataProperties[config["y"]]["dtype"] == "nominal") {
          chart.spec.layer[0].encoding.y.sort = {
            field: config["sort"],
            op: "sum",
            order: config["sort_type"]
          }; //"type":dataProperties[config['sort']]['dtype'],
        } else if (dataProperties[config["x"]]["dtype"] == "nominal") {
          chart.spec.layer[0].encoding.x.sort = {
            field: config["sort"],
            op: "sum",
            order: config["sort_type"]
          }; //"type":dataProperties[config['sort']]['dtype'],
      ...
      if (
        config["averageX"] != "" &&
        typeof config["averageX"] != "undefined"
      ) {
        var axisSelect = "y";
        if (config["y"] == "" || typeof config["y"] == "undefined") {
          config["y"] = config["x"];
      ...
      if (
        config["averageY"] != "" &&
        typeof config["averageY"] != "undefined"
      ) {
        var axisSelect = "x";
  ...
  for (var field in allFields) {
    ...
    queryResponse.fields.measure_like.forEach(function(measure) {
      if (lookerName == measure["name"].replace(".", "_")) {
        ...
        dataProperties[allFields[field]]["valueFormat"] =
          dataFormatDict[String(measure["value_format"])];
    ...
    queryResponse.fields.dimension_like.forEach(function(dimension) {
      if (lookerName == dimension["name"].replace(".", "_")) {
        ...
        dataProperties[allFields[field]]["valueFormat"] =
          dataFormatDict[String(dimension["value_format"])];
